...
if ( !class_exists('cawpConfigurationManager') ){

    class cawpConfigurationManager {
        ...
        /**
         * @var bool Whether options have been successfully loaded.
         */
        public $option_loaded = false;

        function cawpConfigurationManager( $option_name = '', $default_settings = null ){
        ...
        /**
         * cawpOptionManager::load_options()
         * Load plugin options from Wordpress. The current $options values are
         * not affected if this function fails.
         *
         * @param string $option_name
         * @return bool True if options were loaded, false otherwise.
         */
        function load_options( $option_name = '' ){
            $this->option_loaded = false;
        ...
        /**
         * cawpOptionManager::save_options()
         * Save plugin options to WordPress.
         *
